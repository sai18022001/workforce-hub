...
func (_c *UserCreate) AddAssignmentIDs(ids ...int) *UserCreate {
	_c.mutation.AddAssignmentIDs(ids...)
	return _c
}

// AddAssignments adds the "assignments" edges to the ProjectAssignment entity.
func (_c *UserCreate) AddAssignments(v ...*ProjectAssignment) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddTimesheetIDs(ids ...int) *UserCreate {
	_c.mutation.AddTimesheetIDs(ids...)
	return _c
}

// AddTimesheets adds the "timesheets" edges to the Timesheet entity.
func (_c *UserCreate) AddTimesheets(v ...*Timesheet) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
