...
func HasAssignmentsWith(preds ...predicate.ProjectAssignment) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasTimesheets() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTimesheetsWith(preds ...predicate.Timesheet) predicate.User {
	return predicate.User(func(s *sql.Selector) {
